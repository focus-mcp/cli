...
- **Package npm** : `@focus-mcp/cli` sous le scope `@focus-mcp` (org npm réservée).
- **Installation** :
...
| **npm org** | `@focus-mcp` | Scope officiel réservé ; distribution via npm, pas GitHub Releases (contrairement aux briques) |
